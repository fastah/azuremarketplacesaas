...
$generated_code_dir="${current_dir}/../gen/"
$meter_path="${generated_code_dir}/meter"
$saas_path="${generated_code_dir}/saas"
$packageName="azurempsaas"
$sdk_path="../sdk/"
$sdk_version='0.0.1'
$autorest_generator='@autorest/go@4.6.1'
$saas = "saas"
$metering = "metering"
...
#cp -r ./temp/saas/* ../sdk/commercialmarketplace 

mkdir -p .\temp\metering
autorest `
    --go `
    --add-credentials `
    --clear-output-folder=true `
...
# Move the generated files to the "right" location.
#cp -r ./temp/metering/* ../sdk/commercialmarketplace 
